...
#Pathway_out="/scratch/ys98038/UKB/plink2_format/COVID_19/Analyses/MR_result/result_WBC_01_28_5e_8/"
Pathway_out="/scratch/ys98038/UKB/plink2_format/COVID_19/Analyses/MR_result/result_WBC_01_28_5e_9/"
...
for (n in c("HGI_round_4_A2","HGI_round_4_B2",
            ...
            "HGI_round_5_B2",
            "HGI_round_5_C2")) {
  outcomefile=paste(Pathway_geno,  n ,".txt", sep="")
  ####### Change csv file
  ...
  for (e in 1:len_exp_file) {
    if (Trait$V2[e]==0) {
      ...
      exp_dat <- extract_instruments(Trait$V1[e],p1 = 5e-09,clump = TRUE,p2 = 5e-09,r2 = 0.001,kb = 10000)
      if (length(exp_dat$SNP)>0) {
        My_MR(exp_dat,outcome_dat)
      }
    } else if (Trait$V2[e]==30) {
      exp_dat <- extract_instruments(Trait$V1[e],p1 = 8.31e-09,clump = TRUE,p2 = 8.31e-09,r2 = 0.001,kb = 10000)
      if (length(exp_dat$SNP)>0) {
        My_MR(exp_dat,outcome_dat)
      }
      ...
      exp_dat=exp_dat[exp_dat$pval.exposure<5e-9, ]
      ...
      exp_dat$samplesize.exposure = Trait$V4[e]
      exp_dat$id.exposure = Trait$V1[e]
      exp_dat$exposure = Trait$V1[e]
      if (length(exp_dat$SNP)>0) {
        My_MR(exp_dat,outcome_dat)
      }
      ...
      exp_dat=exp_dat[exp_dat$pval.exposure<8.31e-9, ]
